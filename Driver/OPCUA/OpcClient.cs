...
namespace OPCuakafka
{
    ...
    public class OpcClient
    {
            ...
            int maxRetries = DefaultVariables.DefaultMaxConnectionRetries)
        {
            ...
            Console.WriteLine( "Initialized client on endpoint: " + URL);
        } 
        ...
        { 
            try  
            {
                ...
                Console.WriteLine("Connected client to endpoint: " + URL);
            ...
            catch (Exception e) when (e is ArgumentNullException || e is ServiceResultException)
            {
                ...
                // Add to log
                Console.WriteLine("Failed to connect client to endpoint: " + URL + ", current retries: " + CurrentRetries);
                ...
                if (CurrentRetries >= MaxRetries)
                {
                    ...
                    Console.WriteLine("Client on endpoint: " + URL + " is no longer operating.");
        ...
        public void Disconnect()
        {
            ...
            {  
                // TODO: add to log
                Console.WriteLine("While trying to disconnect client from endpoint: " + URL + " experienced: " + e.Message);
            ...
            Console.WriteLine("Disconnected client from endpoint: " + URL);
        }
        ...
        public void ResetEndpoint(string endpoint)
        {
            ...
            Console.WriteLine("Reset endpoint from " + t_endpoint + " to " + URL);
        }
                ...
                if (tempNodeRef != null)
                    ...
                    foreach (MonitoredItem item in SubscriptionSession.MonitoredItems.ToList())
                    {
                        ...
                        {  
                            ...
                            // Add to log 
                            Console.WriteLine("Cancelled subscription to " + tempNodeRef.DisplayName.ToString() + " on client with endpoint: " + URL);
        ...
        public void Subscribe(ReferenceDescription nodeRef, MonitoredItemNotificationEventHandler callback = null, NodeClass allowTypes = NodeClass.Unspecified, int publishingInterval = -1) 
        {
            ...
            if (SanityCheck() && (allowTypes == NodeClass.Unspecified || allowTypes == nodeRef.NodeClass))
            {
                ...
                // Add to log
                Console.WriteLine("Started subscribing to " + nodeRef.DisplayName.ToString() + " on client with endpoint: " + URL);
            }  
        } 
            ...
            if (SanityCheck())
            {
                ...
                foreach (ReferenceDescription rd in nodeRefs)
                {
                    ...
                    if (allowTypes == NodeClass.Unspecified || rd.NodeClass == allowTypes)
                    {
                        ...
                        // Add to log
                        Console.WriteLine("Started subscribing to " + rd.DisplayName.ToString() + " on client with endpoint: " + URL);
                    } 
                }  
        ...
        public void Monitor(bool monitor = true, MonitoredItemNotificationEventHandler callback = null, int publishingInterval = -1)
        {
            ...
            if (SanityCheck())//TODO: add to log 
                ...
                if (!monitor && MonitorServerStatusItem != null)
                {
                    ...
                    // Add to log
                    Console.WriteLine("Stopped monitoring server status on client with endpoint: " + URL);
                }  
                ...
                else if (monitor && MonitorServerStatusItem != null && callback == null) 
                {
                    ...
                    // Add to log
                    Console.WriteLine("Started monitoring server status on client with endpoint: " + URL);
                }  
                else
                {
                    // remove the item from the subscription session
        ...
        { 
            ...
            {
                // Add to log
                Console.WriteLine("Cannot browse nodes on client with endpoint: " + URL + " due to bad connection.");
            ...
            {
                Console.WriteLine("Client with endpoint: " + URL + " does not respond.");
                return new ReferenceDescriptionCollection();
            }
        ...
        private void DefaultCallbackMethod(MonitoredItem item, MonitoredItemNotificationEventArgs e)
        {
            ...
            {
                // Add to log
                Console.WriteLine(item.DisplayName + " { Value:" + value.Value + ", SourceTimestamp:" + value.SourceTimestamp + ", StatusCode:" + value.StatusCode +" }");
            }
        }
        ...
        public DataValueCollection ReadNodes(ReferenceDescriptionCollection nodeRefs)
        {
            ...
            catch (ServiceResultException)
            {
                ...
                Console.WriteLine("Unable to read nodes from endpoint: " + URL);
            }
        ...
        private bool Write(WriteValueCollection collection)
        {
            ...
            } catch (ServiceResultException ex)
            {
                ...
                Console.WriteLine("Unable to write to nodes on server " + URL + " because of " + ex.Message);
                return false;
            } 
        ...
        { 
            ...
            if (ServiceResult.IsBad(e.Status))
            {
                ...
                {
                    // Add to log
                    Console.WriteLine("Connection on client with endpoint: " + URL + " is bad, trying to reconnect.");
                ...
                catch (ServiceResultException) 
                {
                    ...
                    { 
                        ...
                        // Add to log
                        Console.WriteLine("Unable to re-establish a connection to endpoint: " + URL + " client no longer in operation.");
                    }
                }
            }
        }
            ...
            if (Connect() && SanityCheck()) 
            {
                ...
                foreach (KeyValuePair<ReferenceDescription, MonitoredItemNotificationEventHandler> item in References.ToList())
                {
                    ...
                    if (nodesIntact.Contains(item.Key.DisplayName.ToString()))
                    {
                        ...
                        // Add to log
                        Console.WriteLine("Resubscribing to " + item.Key.DisplayName + " on client with endpoint: " + URL);
                    }
                    else 
                    {
                        ...
                        // Add to log
                        Console.WriteLine(item.Key.DisplayName + " no longer exists on endpoint: " + URL + " removing from References." );
                    }
                }
        ...
        private bool SanityCheck()   
        {
            ...
            if (ClientSession == null) if (!Connect())
                {
                    // Add to log
                    //Console.WriteLine("Sanity-check failed on client with endpoint: " + URL);
            ...
            if (SubscriptionSession == null && Operating && ClientSession.Connected)
            {
                ...
                // Add to log
                //Console.WriteLine("Sanity-check successfull on client with endpoint: " + URL);
        ...
        private void ApplyChanges()
        {
            ...
            {  // Add to log
                Console.WriteLine("Unable to update subscription session on client with endpoint: " + URL);
            }
        }
        ...
        public MonitoredItem CreateMonitoredItem(ReferenceDescription nodeRef, MonitoredItemNotificationEventHandler callback = null)
        {
            ...
            {
                // Add to log
                Console.WriteLine("Unable to create MonitoredItem on client with endpoint: " + URL + " due to bad connection.");
                return null;
            }
        ...
        public void ClearReferences()
        {
            ...
            // Add to log 
            Console.WriteLine("Cleared references on client with endpoint: " + URL);
        }
